...
**Update Test Pty Ltd** (ABN/ACN 99 888 777 666), having its principal place of business at 456 Test Ave, Brisbane QLD 4000 ("Client").
...
Provider will provide, as an independent contractor, the Professional tier managed services as detailed in Schedule 1 (Statement of Work).
...
This Agreement shall continue for an initial term of **12** months commencing on the Effective Date.

### 2.2 Renewal

At the end of the Initial Term, this Agreement will automatically renew for successive periods of **12** months each unless either Party provides written notice of its intent not to renew at least **60** days prior to expiration.

### 2.3 Early Termination Fee

If Client terminates this Agreement during the Initial Term without Provider Cause, Client shall pay Provider an early termination fee equal to **50.0%** of the monthly recurring charges multiplied by the remaining months in the Initial Term.
...
The Base Fee will be invoiced monthly in advance. Client will pay Provider within **14** days of the invoice date.

### 3.3 Late Payment

Interest shall accrue on outstanding amounts at **10.0%** per annum.
...
On each anniversary, the Base Fee may be increased by the CPI change (Brisbane, All Groups), capped at **5.0%** per annum.
...
**EXECUTED by Update Test Pty Ltd:**
...
**Support Hours:** Monday-Friday, 8:00am-5:30pm AEST

**After Hours:** 24/7 ticket submission via SOC

## 5. FEES

| Item | Amount (excl. GST) |
|------|-------------------|
| Monthly Base Fee (12 users × $130.00) | $1,560.00 |
| Additional Devices | $0 × $12 |
| After-Hours Support | 250.0/hour |
| Project Work | 200.0/hour |
