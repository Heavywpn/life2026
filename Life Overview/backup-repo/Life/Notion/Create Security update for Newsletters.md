...
- Each $MORE$ item above should be replaced with a MORE link like so: <a href="[https://www.example.com](https://www.example.com/)">MORE</a> with the best link for that item from the input.
