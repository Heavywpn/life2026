[https://www.youtube.com/watch?v=Gy-aPBb0djk](https://www.youtube.com/watch?v=Gy-aPBb0djk)
...
- Learn how to install Nessus, a popular vulnerability scanning tool, on Kali Linux
- Understand the process of downloading, verifying, and installing Nessus
- Learn how to perform a basic network vulnerability scan using Nessus

Instructions

1. 1. Open a web browser and navigate to Tenable's website to download Nessus
2. 1. Download the Nessus Debian AMD64 package
3. 1. Verify the downloaded file's integrity using SHA256 checksum
4. 1. Install Nessus using the command: sudo apt install ./[nessus_package_name].deb
5. 1. Start the Nessus service: sudo systemctl start nessusd.service
6. 1. Access Nessus web interface by navigating to [https://localhost:8834](https://localhost:8834) in your browser
7. 1. Complete the initial setup process, including account creation and activation
8. 1. Update Nessus plugins through the web interface
9. 1. Create a new basic network scan
10. 1. Enter the target IP address or range
11. 1. Configure scan settings as needed
12. 1. Launch the scan and wait for results
13. 1. Review the vulnerability report generated by Nessus

Note: Always ensure you have proper authorization before scanning any networks or systems you do not own.
...
[[Install Nessus for Free and scan for Vulnerabilities (New Way) - Transcript]]
