...
Review the [Troubleshooting](https://github.com/ollama/ollama/blob/main/docs/troubleshooting.md) docs for more about using logs.

**Is my GPU compatible with Ollama?**

Please refer to the [GPU docs](https://github.com/ollama/ollama/blob/main/docs/gpu.md).
