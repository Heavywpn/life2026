...
### [check-dmarc.sh](http://check-dmarc.sh/)
...
open "[https://dmarcian.com/domain-checker/?domain=$DOMAIN](https://dmarcian.com/domain-checker/?domain=$DOMAIN)"  
open "[https://domain-checker.valimail.com/dmarc/$DOMAIN](https://domain-checker.valimail.com/dmarc/$DOMAIN)"